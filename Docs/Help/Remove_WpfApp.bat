...
REM Help Viewer 1.0
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Kay McCormick" /productName "WPF Application Infrastructure" /mediaBookList "WpfApp"
...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation uninstall /vendor "Kay McCormick" /productName "WPF Application Infrastructure" /bookList "WpfApp"
