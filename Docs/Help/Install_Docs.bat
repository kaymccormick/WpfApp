...
REM build time.
IF EXIST "Docs.msha" COPY /Y "Docs.msha" HelpContentSetup.msha
...
REM Install the new content.
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale en-us /wait 0 /operation install /sourceUri "%CD%\Docs.msha"
