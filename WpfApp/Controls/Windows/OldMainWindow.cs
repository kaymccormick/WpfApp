...
namespace WpfApp.Controls.Windows
{
...

    {
        ...
        {
            LogEvents = new LogEventInfoCollection (
                                                    new[]
                                                    {
                                                        new LogEventInfo (
                                                                          LogLevel.Info
...
, RoutedPropertyChangedEventArgs<ILifetimeScope> e
        ...
        public LogEventInfoCollection LogEvents { get ; set ; } 
        ...
        public ILifetimeScope LifetimeScope
        {
            ...
            set => SetValue ( ( DependencyProperty ) LifetimeScopeProperty , value ) ;
        }
        ...
        /// <summary>Handler for DumpDebug command</summary>
        /// <param name="sender">The sender.</param>
        ...
        {
            var foo =
                ResolutionExtensions.Resolve < IEnumerable < TraceListener > > ( LifetimeScope ) ;
