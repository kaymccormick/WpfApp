...
namespace WpfApp.Application
{
    ...
    public partial class App : System.Windows.Application
    {
        ...
        private LogDelegates.LogMethod2 DoLogMethod { get ; }
        ...
        )
        {
            try
            {
                ...
                new LogBuilder ( Logger ).Level ( LogLevel.Debug )
                                         .Message ( message )
                                         .Property ( "callerLineNumbr" , callerFilePath )
        ...
        /// <summary>Raises the <see cref="E:DebugMessage"/> event.</summary>
        /// <param name="e">The <see cref="DebugEventArgs"/> instance containing the event data.</param>
        /// <autogeneratedoc />
