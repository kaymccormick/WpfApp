...
namespace WpfApp
{
    ...
    public static class Props
    {
        ...
        /// <summary>The menu item list collection view changed event</summary>
        /// <autogeneratedoc />
        /// TODO Edit XML Comment Template for MenuItemListCollectionViewChangedEvent
        ...
        /// <autogeneratedoc />
        /// TODO Edit XML Comment Template for LoggerRegisteredEvent
        ...
        public static CollectionView GetMenuItemListCollectionView ( DependencyObject target )
        {
        ...
        )
        {
            switch ( d )
            {
                case UIElement uie :     uie.RemoveHandler ( LoggerRegisteredEvent , handler ) ;
                    break ;
                case ContentElement ce : ce.RemoveHandler ( LoggerRegisteredEvent , handler ) ;
                    break ;
            }
        }
        ...
        )
        {
            switch ( d )
            {
                case UIElement uie :     uie.AddHandler ( LifetimeScopeChangedEvent , handler ) ;
                    break ;
                case ContentElement ce : ce.AddHandler ( LifetimeScopeChangedEvent , handler ) ;
                    break ;
            }
        }
        ...
        private static object CoerceAssemblyList ( DependencyObject d , object baseValue )
        {
            return baseValue ;
        }
        ...
        // [AttachedPropertyBrowsableForType(typeof(Window))]
        /// <summary>Helper for getting <see cref="AssemblyListProperty"/>
        ///   from <paramref name="target" />.</summary>
        /// <param name="target"><see cref="System.Windows.DependencyObject"/> to read
        ///   <see cref="AssemblyListProperty"/> from.</param>
...
//		[ AttachedPropertyBrowsableForType ( typeof ( AssemblyBrowser ) ) ]
        ...
        [AttachedPropertyBrowsableForType ( typeof ( Window ) ) ]
        public static IContainer GetContainer ( DependencyObject target )
        {
